...
segment data use32 class=data
    filepath db "vlad.txt", 0 ; fisierul de unde citesc
    ...
    format_output db "nr de consoane este: %d", 0
    ...
    start:
        ...
        repeta:
            ...
            procesare_caracter:
                ...
                repeta_consoane:
                    cmp BL, [consoane + ECX - 1]
                    jne continua ; daca nu e vocala respectiva sare la urmatoarea vocala                 
                    inc dword[nr_consoane] ; nr_vocale++
                continua:
                    loop repeta_consoane ;decrementeaza ECX
        ...
        final: 
            push dword [nr_consoane] ; pun pe stiva numarul de vocale
